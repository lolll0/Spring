    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,700);">게시판등록</button>				
			...
			<div class="card-body">
				<table class="table table-bordered text-center" >					
					...
					<c:forEach items="${boardList }" var="board">
						<tr style='font-size:0.85em;cursor:pointer;' onclick="OpenWindow('detail.do?from=list&bno=${board.bno }','상세보기',800,700);">
							<td>${board.bno }</td>
